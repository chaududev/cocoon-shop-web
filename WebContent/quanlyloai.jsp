          ...
          <div class="card my-4">
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">LOẠI HÀNG</h6>
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                  <form method="post" action="quanlyloai?them">
       		<input name="but1" type="submit" value="Thêm loại" class="btn btn-success">
       </form>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Ảnh loại</th>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">${l.getMaloai()}</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">${l.getTenloai()}</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <img src="${l.getAnhbanner()}" style="width: 80px;height: 40px">
                      </td>
                      <td> 
            	<form action="xuliloai" method="post">
            		 <input id="msxoa" type="hidden" name="msxoa" value="${l.getMaloai()}">
            		<button type="submit" class="btn btn-danger">Xoá</button>
            	</form></td>
            	 <td> <a href="quanlyloai?maloai=${l.getMaloai()}&tenloai=${l.getTenloai()}&anhbanner=${l.getAnhbanner()}" class="btn btn-success">Cập nhật</a></td>
