    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
       <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="thongke">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card my-4">
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">THỐNG KÊ MẶT HÀNG BÁN CHẠY THÁNG/NĂM</h6>
            ...
            <form action="thongke">
			<h3>Tháng / Năm:</h3>
				<input type="month" name="day" value= "${date }"/>
				<input type="submit" value="Thống kê">
			</form>
            </div>
            <c:choose>
            	<c:when test="${ct.getTenhang()}==null">
            	</c:when>
            	<c:otherwise>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Số lượng bán</th>
                    </tr>
                  </thead>
                  <tbody>
        		...
        		<p class="text-xs text-secondary mb-0">Số lượng tồn : ${ct.getSoluong()}</p>
                     </td>
    				<td>  ${ct.getMota() } </td>
