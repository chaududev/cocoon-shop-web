            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                  <form method="post" action="quanlytaikhoan?them">
       		<input name="but1" type="submit" value="Thêm tài khoản" class="btn btn-success">
       </form>
                    <tr>
                  ...
                  <c:forEach items="${danhsach}" var="l"> 
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">${l.getTendn()}</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0">${l.getQuyen()}</p>
                      </td>
                      <td> 
            	<form action="xulitaikhoan" method="post">
            		 <input id="msxoa" type="hidden" name="msxoa" value="${l.getTendn()}">
            		<button type="submit" class="btn btn-danger">Xoá</button>
            	</form></td>
            	 <td> <a href="quanlytaikhoan?tendn=${l.getTendn()}&matkhau=${l.getMatkhau()}&quyen=${l.getQuyen()}" class="btn btn-success">Cập nhật</a></td>
