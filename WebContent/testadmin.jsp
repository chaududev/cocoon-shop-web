              ...
              <div class="table-responsive p-0">
       		...
       		<input name="but1" type="submit" value="Thêm loại" class="btn btn-success">
                    ...
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Ảnh loại</th>
                  ...
                  <tbody>
                    <tr>
            		 ...
            		 <input id="maxoa" type="hidden" name="maxoa" value="${L.getMaloai()}">
            		<button type="submit" class="btn">Xoá</button>
            	</form></td>
            	 <td> <a href="quanlyloai?maloai=${L.getMaloai()}&tenloai=${L.getTenloai()}" class="btn btn-success">Cập nhật</a></td>
