...
<body>
  ...
  <div style="width: 45%; float:left">
   <img  src="${timhang.getAnh() }"><br>
	</div>
     <div style="width: 55%; float:right">
     <br><br>
   <h3><b>${timhang.getTenhang() }</b></h3>
      <h3><fmt:formatNumber type="number" 
        		maxFractionDigits="3" value="${timhang.getGia() }" />₫</h3>
       <a href="gio?mh=${timhang.getMahang() }&th=${timhang.getTenhang() }&gia=${timhang.getGia() }&anh=${timhang.getAnh() }&dungtich=${s.getDungtich() }"> 
             <img src="images/themgio.JPG" width="200" height="100"> </a>
       <h4><b>Mô tả sản phẩm</b></h4>
       <h5>- ${timhang.getMota() }</h5> 
       <h5><b>- Dung tích :</b> ${timhang.getDungtich() }</h5> 
       <h5><b>- Thành phân :</b> ${timhang.getThanhphan() }</h5> 
       <h5><b>- Hướng dẫn sử dụng : </b>${timhang.getHdsd() }</h5> 
       <h5><b>- Công dụng :</b> ${timhang.getCongdung() }</h5>
       <h5><b>- Hướng dẫn sử dụng :</b> ${timhang.getHdsd() }</h5>
       <br><br>
	</div>
     </div>
